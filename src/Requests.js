...
const requests = {
  ...
  fetchHorrorMovies: `/discover/movies?api_key=${API_KEY}&width_genres=27`,
  fetchRomanceMovies: `/discover/movies?api_key=${API_KEY}&width_genres=10749`,
  fetchDocumentaries: `/discover/movies?api_key=${API_KEY}&width_genres=99`,
};
